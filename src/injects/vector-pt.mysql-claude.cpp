...
static struct
{
    ...
    {1 << 0, "ADMINISTRATIVE"},
    {1 << 1, "CLAUSE_COMPONENT"},
    {1 << 2, "CONSTRAINT_DEFINITION"},
    {1 << 3, "DATA_IMPORT_EXPORT"},
    {1 << 4, "DATA_TYPE"},
    {1 << 5, "DDL_STATEMENT"},
    {1 << 6, "DML_STATEMENT"},
    {1 << 7, "ENTRY_POINT"},
    ...
    {1 << 10, "IDENTIFIER"},
    {1 << 11, "LITERAL_VALUE"},
    {1 << 12, "OPTIONAL_MODIFIER"},
    {1 << 13, "QUERY_STRUCTURE"},
    {1 << 14, "REPLICATION_CLUSTER"},
    {1 << 15, "STORED_PROCEDURE"},
    {1 << 16, "SYNTAX_ELEMENT"},
    {1 << 17, "TABLE_REFERENCE"},
    {1 << 18, "TRANSACTION_CONTROL"},
    {1 << 19, "USER_MANAGEMENT"},
};
