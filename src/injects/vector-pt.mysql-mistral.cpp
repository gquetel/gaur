...
static struct
{
    ...
    {1 << 19, "Data Definition"},
    {1 << 18, "Data Import/Export"},
    {1 << 17, "Data Manipulation"},
    {1 << 16, "Data Query"},
    {1 << 15, "Database Management"},
    {1 << 14, "Locking & Concurrency"},
    {1 << 13, "Miscellaneous Operations"},
    {1 << 12, "Replication & Clustering"},
    {1 << 11, "Resource Management"},
    {1 << 10, "Security & Privileges"},
    {1 << 9, "Statement Control"},
    {1 << 8, "Stored Procedures & Functions"},
    {1 << 7, "System Information"},
    {1 << 6, "System Maintenance"},
    {1 << 5, "System Variables"},
    {1 << 4, "Temporary Objects"},
 ...
 * @param rule_tag Semantic tag for rule
 * @param yykind Kind of the node (given by flex / bison)
 */
void reduce(int n_children, int r_id, int rule_tag, int yykind)
{
 ...
 *  appearance_int:symbol_kind:rule_id:tag::sem_value
 * @param root_node
 * @param f
 */
