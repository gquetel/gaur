...
static struct
{
    ...
    {1 << 5, "Locking & Concurrency"},
    {1 << 6, "Miscellaneous Operations"},
    {1 << 7, "Replication & Clustering"},
    {1 << 8, "Resource Management"},
    {1 << 9, "Security & Privileges"},
    {1 << 10, "Statement Control"},
    {1 << 11, "Stored Procedures & Functions"},
    {1 << 12, "System Information"},
    {1 << 13, "System Maintenance"},
    {1 << 14, "System Variables"},
    {1 << 15, "Temporary Objects"},
    {1 << 16, "Transaction Control"},
    {1 << 17, "Triggers & Events"},
