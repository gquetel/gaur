...
static struct
{
    ...
    {1 << 6, "Expression"},
    {1 << 7, "Identifier"},
    {1 << 8, "Index-Definition"},
    {1 << 9, "Join-Clause"},
    {1 << 10, "Literal"},
    {1 << 11, "Options-List"},
    {1 << 12, "Partition-Clause"},
    {1 << 13, "Predicate"},
    {1 << 14, "Privilege-Control"},
    {1 << 15, "Replication-Control"},
    {1 << 16, "Stored-Program"},
    {1 << 17, "Transaction-Control"},
    {1 << 18, "Utility-Statement"},
    {1 << 19, "Window-Function"},
};
